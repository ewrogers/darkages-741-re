...
| [Motion effect table](motion-effect-table.md) | Moving-effect parameters and expressions | Expression tokens mapped; full row grammar incomplete | Not described |
