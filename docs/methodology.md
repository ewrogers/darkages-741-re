...
<a id="voice-and-worked-explanations"></a>
<a id="diagrams-that-explain-a-relationship"></a>
<a id="authoring-and-checking-figures"></a>

Contributor guidance lives in the [authoring guide](../contributing/authoring.md): [reading depth](../contributing/authoring.md#reading-depth), [voice and worked examples](../contributing/authoring.md#voice-and-worked-explanations), and [diagrams](../contributing/authoring.md#diagrams-that-explain-a-relationship). The [contributor handbook](../CONTRIBUTING.md) connects that craft to the research workflow, generated references, and local checks.
