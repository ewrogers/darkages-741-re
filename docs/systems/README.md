...
Start with the [event system](events.md) and [UI and panes](ui.md) for the shared foundations. The remaining pages cover focused behavior such as movement, dialogs, player interactions, character setup, settings, screenshots, portraits, and formatted text.
