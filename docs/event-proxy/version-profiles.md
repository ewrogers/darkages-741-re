...
| Input-manager destructor | `0x466A80` | `0x00066A80` | 5 | `55 8B EC 6A FF` |
...
|---|---:|---:|---|
| `input_queue_event_copy` | `0x463D10` | `0x00063D10` | Copy a complete `0xA8` event into the synchronized queue |
| `input_dispatch_event_on_main_thread` | `0x463F70` | `0x00063F70` | Central call plus payload cleanup |
| `input_dispatch_or_queue_event` | `0x4670F0` | `0x000670F0` | Direct on main thread, copy from other threads |
| `net_wrap_received_packet_message` | `0x468220` | `0x00068220` | Build network event type `0x13` |
...
| `app_instance` | `0x73D944` | `0x0033D944` | Object vtable is `0x673F68` |
| `app_singleton` | `0x6D9220` | `0x002D9220` | Mirrors the application object after construction |
| `input_manager_instance` | `0x6D9260` | `0x002D9260` | Object vtable is `0x674024` |
...
| `app_vtable` | `0x673F68` | `0x00273F68` | Slot `+0x08` is `0x464180` |
| `input_event_vtable` | `0x674018` | `0x00274018` | Used by `input_event_ctor` |
| `input_manager_vtable` | `0x674024` | `0x00274024` | Used by `input_manager_ctor` |
...
| `+0x74` | pointer | Event sink, the input manager |
...
4. Confirm the application, input manager, and communications vtables match this profile after relocation.
