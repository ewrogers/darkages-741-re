# 035 / 0x23: CExitEditingModePacket?

- Direction: client to server
- Internal packet name: `CExitEditingModePacket?`
...
- This directly favors the same-opcode internal enum name `ExitEditingMode` over the earlier speculative `CScriptPacket` match.
