# 008 / 0x08: CDropPacket

- Direction: client to server
- Internal packet name: `CDropPacket`
- Local behavioral alias: `DropItem`
- Related-game enum name: `Drop`
...
- Byte 0 of the untransformed body is opcode `0x08`.
