# 005 / 0x05: Map CRC (`CMapCRC`)

- Direction: client to server
- Internal name: `CMapCRC`
...
- This strongly supports the leaked internal name `CMapCRC` despite its opcode moving from `0x35` in the sibling game to `0x05` here.
