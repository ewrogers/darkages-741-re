...
This patch changes only endpoint setup. It does not switch the whole distribution mode. Without the [official fallback patch](disable-official-endpoint-fallback.md), a failed connection can still retry `da0.kru.com`.
