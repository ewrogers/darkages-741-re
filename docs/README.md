...
Start with [Getting Started](getting-started.md), then read the [Analysis Method](methodology.md). Verified analysis currently covers [startup controls](client/startup.md), [initial connection behavior](network/initial-connection.md), [network architecture](network/architecture.md), [packet transforms](network/packet-transforms.md), and direction-specific [client](network/client/README.md) and [server](network/server/README.md) packet indexes.
