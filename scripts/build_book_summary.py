...
def main() -> None:
    ...
    lines.extend([
        ...
        "    - [Application functions](appendix/functions/application.md)",
        "    - [Game loop functions](appendix/functions/game-loop.md)",
        "    - [Event functions](appendix/functions/events.md)",
        "    - [Input functions](appendix/functions/input.md)",
        "    - [UI functions](appendix/functions/ui.md)",
        "    - [Network functions](appendix/functions/network.md)",
        "    - [Rendering functions](appendix/functions/rendering.md)",
        "    - [Audio functions](appendix/functions/audio.md)",
        "    - [Map and file functions](appendix/functions/maps-and-files.md)",
        "    - [Crypto functions](appendix/functions/crypto.md)",
        "    - [Uncertain functions](appendix/functions/uncertain.md)",
        "    - [Other functions](appendix/functions/other.md)",
