...
python3 scripts/build_function_reference.py --check
python3 -m unittest discover -s scripts/tests -p 'test_*.py'
node --test scripts/tests/test_function_lookup.cjs
mdbook build
python3 scripts/check_book_links.py book
```
